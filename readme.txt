...
Bugfix: fixed issue with permalinks

= 1.9.7 =

New Feature: allows for control of the taxonomies shown in the library widget.
New Feature: adds proper labels for all taxonomies
New Feature: pretty url permalinks for all taxonomies (i.e. person, camera, lens, keyword, city, etc...)
...
Bug fix: added missing "after widget" markup to the exif widget.

= 1.9.3 =

Bug fix: removing hard coded H2 tags from widget title. Updated titel output ot relfect widgets API.

= 1.9.2 =

Bug fix: defense around broken EXIF tags generated by some cameras.
Bug fix: Performance speed up by removing redundnat extration call.
